...
public class Main {
    public static void main(String[] args) {
        ...
        Task task1 = new Task(1, "Задача1", "Важная задача 1", TaskStatus.NEW);
        Task task2 = new Task(2, "Задача2", "Интересная задача 2", TaskStatus.NEW);
        Epic epic1 = new Epic(3, "Эпик 1", "Супер эпик 1.2", TaskStatus.NEW);
        Epic epic2 = new Epic(4, "Эпик 2", "Классный эпик 2.1", TaskStatus.NEW);
